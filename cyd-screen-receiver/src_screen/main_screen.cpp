...
// // =============================================
// // CYD joins the camera hotspot
// // =============================================
// const char* WIFI_SSID = "PlastibotCam";
// const char* WIFI_PASS = "plastibot123";
...
// // Simple known-good JPEG block callback
...
//       Serial.printf("RX FPS: %u | JPEG: %u bytes | chunks: %u\n",
//                     frames, jpegSize, expectedChunks);
//       frames = 0;
//       lastMs = millis();
//     }
...
//   Serial.begin(115200);
//   delay(500);
//   Serial.println("\nCYD WiFi UDP Receiver starting...");
